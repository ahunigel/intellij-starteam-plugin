...
public class StarteamVcsAdapter extends AbstractVcs implements ProjectComponent, JDOMExternalizable {
  ...
  @NonNls
  private static final String PERSISTENCY_RENAMED_TAG = "StarbasePersistencyRenamedFile";
  @NonNls
  private static final String PERSISTENCY_NEW_FILE_TAG = "StarbasePersistencyNewFile";
  @NonNls
